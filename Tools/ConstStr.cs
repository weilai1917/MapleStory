...
namespace EasyMaple
{
    public class ConstStr
    {
        ...
        public readonly static string mapleLogin = "http://nxgamechanneling.nexon.game.naver.com/login/loginproc.aspx?redirect=https%3a%2f%2fmaplestory.nexon.game.naver.com%2fHome%2fMain&ts=20190629215725&gamecode=589824";
        public readonly static string mapleHome = "https://maplestory.nexon.game.naver.com/Home/Main";
        ...
        static ConstStr()
        {
            ...
            if (config.CkTestWord)
            {
                ...
                mapleLogin = "http://nxgamechanneling.nexon.game.naver.com/login/loginproc.aspx?redirect=https%3a%2f%2fmaplestory.nexon.game.naver.com%2fTestworld%2fMain&ts=20190629215725&gamecode=589824";
            }
        }
